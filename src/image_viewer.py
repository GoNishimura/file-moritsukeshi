...
class ImageViewer(tk.Toplevel):
  def __init__(self, parent, image_path):
    ...
    self.footer_col1.pack(side="left")
    self.prev_button = tk.Button(self.footer_col1, text="< 前", command=self.show_prev_image)
    self.filename_label = tk.Label(self.footer_col1, text=os.path.basename(image_path), font=("Arial", 12))
    self.next_button = tk.Button(self.footer_col1, text="次 >", command=self.show_next_image)
    self.prev_button.pack(side="left", padx=5, pady=5)
    self.filename_label.pack(side="left", padx=5, pady=5)
    self.next_button.pack(side="left", padx=5, pady=5)
    
    # フッターの2列目（拡大縮小）
    self.footer_col2 = tk.Frame(self.footer)
    self.footer_col2.pack(side="right")
    self.zoom_out_button = tk.Button(self.footer_col2, text="ー", command=self.zoom_out)
    self.zoom_label = tk.Label(self.footer_col2, text="100%")
    self.fit_button = tk.Button(self.footer_col2, text="全体表示", command=self.fit_to_window)
    self.zoom_in_button = tk.Button(self.footer_col2, text="＋", command=self.zoom_in)
    ...
    # フッターの3列目（画像情報）
    self.footer_col3 = tk.Frame(self.footer)
    self.footer_col3.pack(fill="x")
    self.image_info_label = tk.Label(self.footer_col3, text="", font=("Arial", 10))
